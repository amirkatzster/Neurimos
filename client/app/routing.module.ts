...
const routes: Routes = [
  ...
  { path: 'admin/shoes', component: MenuComponent, canActivate: [AuthGuardAdmin] },
  { path: 'admin/companies', component: MenuComponent, canActivate: [AuthGuardAdmin] },
  { path: 'admin/classifications', component: MenuComponent, canActivate: [AuthGuardAdmin] },
  { path: 'admin/users', component: MenuComponent, canActivate: [AuthGuardAdmin] },
  { path: 'admin', redirectTo: 'admin/shoes', pathMatch: 'full' },
